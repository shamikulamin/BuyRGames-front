            ...
            <div className="container">
                <span >
                    <div id="superBox" className="row block-example border-top  border-dark">
                        ...
                        <div className="col-6">
                            <h4> <Link className="link" to={{ pathname: "/product/" + this.state.inputValue, state: "desiredState" }}>
                            
                                {this.props.products.name}
                            </Link></h4>
                            <h6 className="text-muted">for <strong>{this.state.platformMap[this.props.products.platform]}</strong></h6>
                            <h6 className="text-muted">By {this.props.products.publisher}</h6>
                            <img className = "esrbClass" src = {this.state.esrbMap[this.props.products.esrb_rating]} alt="Card cap"/>
                        </div>
